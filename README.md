...
1. [Joint Exponential Time-to-Event Model for Efficacy and Dropout with Logistic Toxicity](https://heartofsaigon.github.io/published_docs/01.html)
2. [Knowledge-Gradient Stopping Rule for Bayesian Ranking-and-Selection (and BO Intuition)](https://heartofsaigon.github.io/published_docs/02.html)
3. 
4. [Two Ways to Add Prior Information in Gaussian Process Models: Virtual Constraints vs Historical Trajectories](https://heartofsaigon.github.io/published_docs/04.html)
...
18. [Lecture Notes on Power, Assurance, Conditional Power, Predictive Power, and Related Operating Characteristics](https://heartofsaigon.github.io/published_docs/17.html)